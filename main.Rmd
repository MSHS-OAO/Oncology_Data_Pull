...
SELECT h.*, nvl(h.NEW_PT_ARRIVED_RAW, 'ESTABLISHED') AS NEW_PT_ARRIVED, count(*) over () totalRows
FROM( 
...
FROM( 
        ...
        a.LOS_CODE, b.DEPARTMENT_NAME, b.DEPARTMENT_ID, b.SITE, c.ASSOCIATIONLISTA, c.ASSOCIATIONLISTB, c.ASSOCIATIONLISTT, 
        a.PAT_ID,
