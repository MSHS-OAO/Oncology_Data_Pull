...
oncology_active_treatment_table_drop <- glue("DROP TABLE ONCOOGY_ACTIVE_TREATMENT_MRN")

oncology_active_treatment_table <- glue ("CREATE TABLE ONCOOGY_ACTIVE_TREATMENT_MRN AS
...
if(dbExistsTable(con, "ONCOOGY_ACTIVE_TREATMENT_MRN")) {
