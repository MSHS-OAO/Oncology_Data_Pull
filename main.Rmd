...
update_columns_dx_grouper <- glue("UPDATE ONCOLOGY_ACCESS
   SET DISEASE_GROUP = NVL(DISEASE_GROUP, 'Non-Cancer')
 WHERE DISEASE_GROUP IS NULL")

update_columns_dx_detail <- glue("UPDATE ONCOLOGY_ACCESS
   SET DISEASE_GROUP_DETAIL = NVL(DISEASE_GROUP_DETAIL, 'Non-Cancer')
 WHERE DISEASE_GROUP_DETAIL IS NULL")
