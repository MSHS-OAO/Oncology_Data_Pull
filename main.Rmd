...
FROM( 
        ...
        a.PAT_ID,
        c.INPERSONVSTELE, d.DISEASE_GROUP, d.DISEASE_GROUP_B AS DISEASE_GROUP_DETAIL, d.PROVIDER_TYPE, e.DX_DETIAL, e.DX_GROUPER, i.RACE, i.MYCHART_STATUS, z.ETHNIC_BACKGROUND,
